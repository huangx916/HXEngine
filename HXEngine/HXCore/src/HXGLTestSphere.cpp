...
namespace HX3D
{
	...
	void HXGLTestSphere::Initialize()
	{
		...
		render_mvp_matrix_loc = glGetUniformLocation(ibl_diff_prog, "hx_WVP");
	...
	void HXGLTestSphere::Render(GLuint tex_obj)
	{
		...
		glUniform3f(eye_pos_loc, 0.0f, 0.0f, 100.0f);

		vmath::mat4 mMatrixModel = vmath::mat4::identity();
		vmath::mat4 mMatrixProjection = vmath::perspectiveExt(90, 1, 0.1f, 1000);
		vmath::mat4 mMatrixView = vmath::lookat(vmath::vec3(0, 0, 100), vmath::vec3(0, 0, -1), vmath::vec3(0, 1, 0));
