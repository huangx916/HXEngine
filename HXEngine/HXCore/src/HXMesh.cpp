...
namespace HX3D
{
	...
	void HXMesh::CreateCubeForTest()
	{
		...
		vertex0up.color = HXCOLOR(255, 0, 0, 255);
		vertex0up.u = 0;
		vertex0up.v = 1;
		...
		vertex2up.color = HXCOLOR(255, 0, 0, 255);
		vertex2up.u = 1;
		vertex2up.v = 0;
		...
		vertex3up.color = HXCOLOR(255, 0, 0, 255);
		vertex3up.u = 0;
		vertex3up.v = 0;
		...
		vertex7bottom.color = HXCOLOR(255, 0, 0, 255);
		vertex7bottom.u = 0;
		vertex7bottom.v = 1;
		...
		vertex5bottom.color = HXCOLOR(255, 0, 0, 255);
		vertex5bottom.u = 1;
		vertex5bottom.v = 0;
		...
		vertex4bottom.color = HXCOLOR(255, 0, 0, 255);
		vertex4bottom.u = 0;
		vertex4bottom.v = 0;
		...
		vertex0left.color = HXCOLOR(255, 0, 0, 255);
		vertex0left.u = 0;
		vertex0left.v = 1;
		...
		vertex3left.color = HXCOLOR(255, 0, 0, 255);
		vertex3left.u = 1;
		vertex3left.v = 1;
		...
		vertex7left.color = HXCOLOR(255, 0, 0, 255);
		vertex7left.u = 1;
		vertex7left.v = 0;
		...
		vertex4left.color = HXCOLOR(255, 0, 0, 255);
		vertex4left.u = 0;
		vertex4left.v = 0;
		...
		vertex2right.color = HXCOLOR(255, 0, 0, 255);
		vertex2right.u = 0;
		vertex2right.v = 1;
		...
		vertex5right.color = HXCOLOR(255, 0, 0, 255);
		vertex5right.u = 1;
		vertex5right.v = 0;
		...
		vertex3front.color = HXCOLOR(255, 0, 0, 255);
		vertex3front.u = 0;
		vertex3front.v = 1;
		...
		vertex2front.color = HXCOLOR(255, 0, 0, 255);
		vertex2front.u = 1;
		vertex2front.v = 1;
		...
		vertex7front.color = HXCOLOR(255, 0, 0, 255);
		vertex7front.u = 0;
		vertex7front.v = 0;
		...
		vertex0back.color = HXCOLOR(255, 0, 0, 255);
		vertex0back.u = 1;
		vertex0back.v = 1;
		...
		vertex4back.color = HXCOLOR(255, 0, 0, 255);
		vertex4back.u = 1;
		vertex4back.v = 0;
		...
		vertex5back.color = HXCOLOR(255, 0, 0, 255);
		vertex5back.u = 0;
		vertex5back.v = 0;
